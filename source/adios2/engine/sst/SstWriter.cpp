...
void SstWriter::EndStep()
{
    ...
    if (m_MarshalMethod == SstMarshalFFS)
    {
        ADIOST_SCOPED_TIMER("Marshaling Overhead");
        ADIOST_START("SstMarshalFFS");
        FFSMarshalAttributes();
        ADIOST_STOP("SstMarshalFFS");
    ...
    else if (m_MarshalMethod == SstMarshalBP)
    {
        ...
        ADIOST_START("Marshaling overhead");
        ...
        ADIOST_STOP("Marshaling overhead");
